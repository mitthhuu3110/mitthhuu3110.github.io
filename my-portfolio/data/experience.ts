...
export const experiences: Experience[] = [
  {
    ...
    bullets: [
      ...
      'Built PCAS chatbot (Public Cloud AI Support) leveraging GPT-4.0, Dialogflow, Elasticsearch, and spaCy to handle 500+ daily support queries using a conversational interface integrated with internal documents.',
    ],
  },
  {
    ...
    bullets: [
      ...
      'Integrated API documentation and security measures using OpenAPI (Swagger) and Apigee; streamlined developer onboarding.',
