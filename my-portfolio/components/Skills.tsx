  ...
  return (
    ...
    >
      <div className="max-w-5xl w-full text-center">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 font-mono mb-10 px-2 sm:px-0">
        ...
        <div className="space-y-12">
          {skills.map((group, idx) => (
            <div key={idx}>
              ...
              <div className="flex flex-wrap justify-center sm:justify-center gap-3 sm:gap-4">
                {group.items.map((item, i) => (
                  ...
                  >
                    ...
                    />
                    <span className="text-sm font-medium text-gray-800 dark:text-gray-200 font-sans whitespace-nowrap">
                      {item.name}
                    </span>
                  </motion.div>
                ))}
