  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="inline-flex items-center justify-center gap-3 text-sm sm:text-base font-mono px-4 py-2 text-gray-700 dark:text-gray-300">
        ...
        <div className="relative text-sm sm:text-base leading-relaxed text-left px-6 py-6 bg-gradient-to-br border border-zinc-300 dark:border-zinc-700 rounded-md shadow-inner">
          <div className="absolute -top-3 left-6 px-2 bg-[color:var(--bg)] text-[10px] uppercase tracking-widest font-bold text-brand-orange">
            CURRENTLY BUILDING
          </div>
          Building scalable systems that are efficient, secure along with high performance, automating boring stuff, and breaking production (with permission) at Ford.<br />
          ...
          <span className="text-brand-orange font-semibold font-mono">Databases(PostgreSQL)</span>,{' '}
